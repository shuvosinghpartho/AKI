  ...
  <div class="filtering-container" :class="{ 'desktop-collapsed': isCollapsed }">
    ...
    <nav class="sidebar" :class="{ 'mobile-open': showMobileSidebar }">
      ...
      <div class="sidebar-footer">
        <button class="nav-next" @click="goToProcess">
          <span>NEXT STEP</span>
...
.filtering-container.desktop-collapsed .sidebar { width: 80px; }
.filtering-container.desktop-collapsed .hide-on-collapse { opacity: 0; display: none; }
